...
export default function RsvpForm({ slug, token, guest }) {
  ...
  if (status === 'done') {
    return (
      <p
        className="text-center font-serif italic text-lg py-6"
  ...
  return (
    ...
    >
      <p className="text-center text-sm font-serif italic text-[var(--color-text)]/70">
      ...
      <div className="flex gap-3">
        <button
          ...
          className="flex-1 py-2 text-sm border-2 transition"
          style={
            attending
              ? {
      ...
      {attending && (
        <div>
          <label className="text-xs tracking-wide uppercase text-[var(--color-text)]/50">
      ...
      <button
        ...
        className="w-full py-3 text-sm tracking-wide uppercase text-xs border-2 disabled:opacity-50"
        style={{
          backgroundColor: 'var(--color-primary)',
          color: 'white',
          borderColor: 'var(--color-primary)',
